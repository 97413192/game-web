...
public class BioHelper {
	...
	public static final String getCStr(IoBuffer buf) throws IOException {
	...
	public static final void putCStr(IoBuffer buf, String v)
			throws IOException {
	...
	public final static byte[] objectToBytes(Object o) throws IOException {
		LuaOutputStream out = LuaOutputStream.allocate(1024);
		out.write_object(o);
	...
	public final static byte[] objectToBytes(Object o, int buffLen)	throws IOException {
		LuaOutputStream out = LuaOutputStream.allocate(buffLen);
		out.write_object(o);
		byte[] ret  = out.toByteArray();
		out.free();
		return ret;
