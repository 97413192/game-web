...
<script language="javascript" type="text/javascript">
	$(function(){//页面载入完毕
		...
		$("#load").click(function(){
			...
			var userPass = $("#txtUserPass").val().trim();
...
// 			        alert("记住了你的密码登录。");  
			    	if(ok){
						$.ajax({
							url:"login/login.do",
							type:"post",
							data:{"name":userName,"password":userPass,"system":system},
							dataType:"json",
                        ...
                        <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                            <div class="form-group">
                                <div class="field field-icon-right">
                                    <input type="text" class="input input-big" name="txtUserName" id="txtUserName" placeholder="登录账号" />
                                    <span class="icon icon-user margin-small"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="field field-icon-right">
                                    <input type="password" class="input input-big" name="txtUserPass" id="txtUserPass"  placeholder="登录密码" />
