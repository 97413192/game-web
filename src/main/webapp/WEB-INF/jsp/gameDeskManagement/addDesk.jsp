...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#CreateDesk").click(function(){
			...
			//发送ajax请求
			$.ajax({
				url:"gameDesk/addGameDesk.do",
				type:"post",
				data:{"gameId":gameId,"roomId":roomId,"maxGoldStock":maxGoldStock,"curGoldStock":curGoldStock},
				dataType:"json",
				success:function(result){
					if(result.status == 0){
						alert(result.msg);
	...
	<form name="form1" method="post" action="" id="form1">
		...
		<table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
			...
			<tr>
				...
				<td colspan="2" align="left">
					<input name="maxGoldStock" type="text" id="maxGoldStock" class="put" maxlength="12" 
						onkeyup="filterInput();check();"/>
					<span id="userpwdmsg_01" class="red">库存最低为250000</span>
				</td>
			</tr>
			<tr>
				<td align="right">
				...
				<td colspan="2" align="left">
					<input name="curGoldStock" type="text" id="curGoldStock" class="put" maxlength="12" 
						onkeyup="filterInput();check();"/>
					<span id="userpwdmsg_02" class="red">建议当前金币库存等于最大金币库存</span>
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="2" align="left">
					<input type="button" name="CreateDesk" value=" 创 建 " id="CreateDesk" disabled = "disabled"/>
