...
<script type="text/javascript">
	...
	alert(i){
		...
		if(ok){
			发送请求ajax请求
			$.ajax({
				url:"sign/selectAllSign.do",
				type:"post",
				data:{"gold":gold,"id":id},
				dataType:"json",
...
<body>
    <form name="form1" method="post" action="" id="form1">
        <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
            ...
            <c:forEach items="${signList}" var="log" varStatus="s">
            	<tr>
            		<td>${s.index+1 }</td>
	                ...
	                <td>${log.gold }</td>
	                <td>
	                	修改签到金币<input type="text" id="${log.id+20 }" onkeyup = "filterInput()">
